...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "family_realm_production"
  ...
  # Включаем режим симуляции для бесплатного сервера Render
  config.action_mailer.delivery_method = :logger

  # Обязательно оставь ссылку на твой сайт!
  config.action_mailer.default_url_options = { host: 'family-realm.onrender.com', protocol: 'https' }
